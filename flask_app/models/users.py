...
class User:
    ...
    def get_by_email(cls, formulario):
        ...
        query = "SELECT * FROM users WHERE email = %(email)s"
        result = connectToMySQL('belt_reviewer').query_db(query, formulario)# SELECT regresa siempre una lista, si no existe es una lista vacia, el usuario 0 es el que inicia sesion
